    ...
    async function getPlants(e) {
        ...
        const res = await fetch("/api/accessDatabase", {
            ...
            body: JSON.stringify({
                ...
                columns: ['plant.genus', 'plant.species','plant.species_id', 'collection_id','plant.common_name', 'seed_collection.col_location', 'seed_collection.collected_date', 'seed_collection.id_method', 'seed_collection.id_confidence', 'seed_collection.cleaned_weight', 'seed_collection.cleaning_effectiveness', 'users.email', 'users.phone_number', 'users.website'],
                column_names: ['Genus', 'Species','Species ID','Collection ID', 'Common Name','Location', 'Collected Date', 'ID Method', 'ID Confidence', 'Cleaned Weight', 'Cleaning Effectiveness', 'Email', 'Phone Number', 'Website'],
